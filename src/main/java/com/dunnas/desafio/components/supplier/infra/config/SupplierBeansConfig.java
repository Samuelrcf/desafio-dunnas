...
import com.dunnas.desafio.components.supplier.application.usecases.impl.FetchSupplierInfoUseCaseImpl;
...
public class SupplierBeansConfig {
    ...
    @Bean
    FetchSupplierInfoUseCase fetchSupplierInfoSupplierUseCase(SupplierRepositoryGateway supplierRepositoryGateway, SupplierDomainMapper supplierDomainMapper, CurrentUserProvider currentUserProvider) {
    	return new FetchSupplierInfoUseCaseImpl(supplierRepositoryGateway, supplierDomainMapper, currentUserProvider);
    }
